...
namespace DisciplinarySystem.Presentation.Controllers.Objections
{
    ...
    public class ObjectionController : Controller
    {
        ...
        public ObjectionController(IObjectionService objService, IComplainingService cmpService, IWebHostEnvironment hostEnv, IPrimaryVoteService primaryVoteService)
        {
